...
class Producer:
    ...
    def random_property_type():
        return  random.choice(( "Apartment", "Farmhouse", "Independent House", "Studio", "Townhouse", "Villa",))

    @staticmethod
    @jsonize
    def random_furnishing_status():
        return  random.choice( ( "Fully-Furnished", "Semi-Furnished", "Unfurnished"))
    ...
    def gen_telemetry_houses() -> str:
        ...
        city_p = Producer.random_city()
        country = Producer.city_country_map(city_p)
        city= f""" "{city_p}" """
        property_type = Producer.random_property_type()
        furnishing_status = Producer.random_furnishing_status()
        ...
        garage = Producer.random_bool()
        garden = Producer.random_bool()
        crime_cases_reported = random.randint(0,11)
        legal_cases_on_property = Producer.random_bool()
